...
const AnnouncementCard: React.FC<AnnouncementCardProps> = ({ modalObj }) => {
  ...
  const openModal = () => {
    modalObj.setModal(<Lightbox large={imagePath} alt="The Infamous Matos" onClose={closeModal} hideDownload />)
  }
  ...
  return (
    <StyledAnnouncementCard>
      <CardBody>
        ...
        <Text>{t('Bitconnect series is live in the Catacombs!')}</Text>
        <br />
        <Flex alignItems="center" flexDirection="column" width="100%" onClick={openModal}>
          <img width="40%" src={imagePath} alt="The Infamous Matos Nft" />
        </Flex>
