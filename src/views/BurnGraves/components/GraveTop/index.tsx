            ...
            <tbody>
                <tr>
                    ...
                    <td className="td-width-17">
                        <DisplayFlex>
                            <div className="total-earned">{numeral(getBalanceAmount(grave.poolInfo.totalBurned)).format('(0.000a)')}</div>
                            <div className="earned">Burned (ZMBE)</div>
                        </DisplayFlex>
                    </td>
                    <td className="td-width-17">
                        <DisplayFlex>
                            <div className="total-earned">{numeral(getBalanceAmount(grave.poolInfo.totalBurned).times(zmbePrice)).format('($ 0.00 a)')}</div>
                    ...
                    {isDesktop 
                        ? <td className='td-width-25'>
                            <DisplayFlex>
                                <span
                                    className='total-earned'>{numeral(getBalanceAmount(grave.poolInfo.totalStaked).times(stakeTokenPrice)).format('($ 0.00 a)')}</span>
