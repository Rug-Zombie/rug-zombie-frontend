...
const TableList: React.FC<TableList> = ({ id, totalStaked, tokenPrice, handler }) => {
                ...
                <tr>
                    ...
                    {isDesktop 
                        ? <td className='td-width-25'>
                            <DisplayFlex>
                                <span
                                    className='total-earned'>{numeral(getBalanceAmount(totalStaked).times(tokenPrice)).format('($ 0.00 a)')}</span>
