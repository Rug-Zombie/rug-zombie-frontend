...
const NftCard: React.FC<NftCardProps> = ({ name, rznftid, dodnftid, artist }: NftCardProps) => {
  ...
  const [onConvertNftModal] = useModal(<ConvertNftModal rznftid={rznftid} />)
      ...
      <CardBody>
        ...
        <div className="rug-indetails">
            ...
            <div className="sc-iwajpm dcRUtg">
              {dodnft.type === 'image' ? (
                ...
                <video width="100%" autoPlay loop>
                  <source src={dodnft.path} type="video/mp4" />
                </video>
              )}
            </div>
          </div>
          ...
          <div className="direction-column">
            ...
            <button onClick={onConvertNftModal} className="btn btn-disabled w-100" type="button">
