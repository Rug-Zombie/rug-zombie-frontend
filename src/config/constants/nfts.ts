...
const nfts: Nft[] = [
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmXWRkphg4cZGeUr3pWME8esNmZWSiUg5pG9kq4iFSKFfy',
    type: 'video',
    rarity: 'Common',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmccqnhoPg8g8mVrMua5Fc2d3ZY8PLoAvEkFteFrVC9zkx',
    type: 'video',
    rarity: 'Uncommon',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmVDfVDfRHiTQ14gABKF7nHXZ2XmLXEyVJgxGyeq1u2Dvt',
    type: 'image',
    rarity: 'Biblical',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmXKNLfFf5wXizx6NhERq6CHbRdST544b6zoaTJyzzUniu',
    type: 'image',
    rarity: 'Rare',
    userInfo: { ...DEFAULT_USER_INFO },
  },
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/Qmdg19WTKxcbKA5KfZda2L797w6CqTwNhNiseMUMF345DQ',
    type: 'image',
    rarity: 'Rare',
    artist: artists.ayaz_psd,
    userInfo: { ...DEFAULT_USER_INFO },
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmUc7r4kAav8A3qYPmoU3DrXQBVDnXo96mBtm1V7nCXJbC',
    type: 'video',
    rarity: 'Legendary',
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmPTEnyNszqJJSVb9YPgxnXBAzUTWHKoRpXKcE4kQxLurb',
    type: 'video',
    rarity: 'Legendary',
  ...
  },
  {
    ...
    totalSupply: BIG_ZERO,
    path: 'https://ipfs.io/ipfs/QmVnEpNFCux5HGPoLeSepyyopjXqcw6wXGdmDDTsmzoAgU',
    type: 'video',
    rarity: 'Legendary',
    artist: artists.canadiancryptojunkie,
    userInfo: { ...DEFAULT_USER_INFO },
